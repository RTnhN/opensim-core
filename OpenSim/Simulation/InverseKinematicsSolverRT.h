#ifndef OPENSIM_INVERSE_KINEMATICS_SOLVER_RT_H_
#define OPENSIM_INVERSE_KINEMATICS_SOLVER_RT_H_
/* -------------------------------------------------------------------------- *
 *                    OpenSim:  InverseKinematicsSolverRT.h                     *
 * -------------------------------------------------------------------------- *
 ...
 * values. The InverseKinematicsSolverRT provides the option to convert the
 ...
 * solution.
 *
 * The InverseKinematicsSolverRT objective:
 * \f[
 ...
 * @author Ajay Seth
 */
class OSIMSIMULATION_API InverseKinematicsSolverRT: public AssemblySolver
{
//==============================================================================
// METHODS
//==============================================================================
public:
    ...
    // CONSTRUCTION
    //--------------------------------------------------------------------------
    virtual ~InverseKinematicsSolverRT() {}
    // No need for copy constructor or operator
    InverseKinematicsSolverRT(const InverseKinematicsSolverRT& other)            = delete;
    InverseKinematicsSolverRT& operator=(const InverseKinematicsSolverRT& other) = delete;

    InverseKinematicsSolverRT(const Model& model, 
    ...
    InverseKinematicsSolverRT(const Model& model,
            ...
            SimTK::Array_<CoordinateReference>& coordinateReferences,
            double constraintWeight = SimTK::Infinity): 
        InverseKinematicsSolverRT(model,
    ...
    /**Add data to the orienation reference*/
    void updateOrientationData(double time, const SimTK::RowVectorView_<SimTK::Rotation_<double>>& dataRow);
...
//=============================================================================
};  // END of class InverseKinematicsSolverRT
//=============================================================================
} // namespace

#endif // OPENSIM_INVERSE_KINEMATICS_SOLVER_RT_H_
